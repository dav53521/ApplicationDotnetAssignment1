...
namespace ApplicationDotnetAssignment1.Models
{
    public class Appointment
    {
        ...
        public override string ToString()
        {
            ...
            //We're using the null forgiving operator `!` as the Doctor and Patient should not be blank as they're required meaning that it is not possible to create an appointment without them.
