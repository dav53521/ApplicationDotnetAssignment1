...
namespace ApplicationDotnetAssignment1.Models
{
    ...
    public static class PatientExtention
    {
        public static string GetPatientAsRow(this Patient patient)
        {
            ...
            return string.Format("{0,-20} | {1,-20} | {2,-30} | {3,-30} | {4,-10}", patient.Name, patient.AssignedDoctor?.Name ?? "", patient.Email, patient.Address, patient.PhoneNumber);
        }
    }
}
